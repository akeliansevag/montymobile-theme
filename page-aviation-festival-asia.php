        ...
        <div class="sign-ups">
            ...
            <div class="sign-up-two">
                <div class="sign-up-form-container">
                    <h1><strong>Meet Us @Aviation Festival Asia</strong>
                    </h1>
                            ...
                            <div class="two-columns">
                                ...
                                <div class="input-wrapper">
                                    ...
                                    <select name="product">
                                        ...
                                        <option value="Travel eSIM Reseller">Travel eSIM Reseller</option>
                                        <option value="Travel eSIM White Label">Travel eSIM White Label</option>
                                        <option value="Travel eSIM API">Travel eSIM API</option>
                                    </select>
...
<script>
    ...
    document.querySelector('input[name="datetime"]').addEventListener('input', function(e) {
        document.getElementById('error-container').innerHTML = '';
        document.getElementById('datetimeError').textContent = "";
        this.classList.remove('error-border');
    });

    document.querySelector('select[name="product"]').addEventListener('input', function(e) {
        document.getElementById('error-container').innerHTML = '';
    ...
    signUpForm.addEventListener('submit', function(e) {
        ...
        if (!dateTime.value) {
            showError(dateTime, dateTimeError, 'Date and Time are required.');
            isValid = false;
        } else if (hasSpaces(dateTime.value)) {
            showError(dateTime, dateTimeError, 'Ensure there are no spaces at the beginning or end.');
            isValid = false;
        } else {
        ...
        if (isValid) {
            ...
            fetch('https://montymobile.com/wp-json/contact-form-7/v1/contact-forms/25797/feedback', {
                    method: 'POST',
                    headers: {
                        'LanguageCode': 'en',
                    },
